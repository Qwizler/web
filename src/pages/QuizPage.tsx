...
const questions: QuizQestion[] = [
	...
	},
	{
		...
		question: "Which programming language was created by Brendan Eich in 1995 and became a cornerstone of web development, powering interactive features on countless websites worldwide?",
	...
	},
	{
		...
		question: "In quantum mechanics, what is the term for the phenomenon where two or more particles become correlated in such a way that the quantum state of each particle cannot be described independently, even when separated by a large distance?",
		...
		<div className="flex h-full w-full flex-col items-center gap-4 px-4 py-8 sm:px-6 lg:px-8">
			<div className="w-full max-w-3xl flex flex-col gap-4">
				...
				<div className="mt-6 flex justify-center gap-4">
					<Button variant="outline" className="w-36 transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-700">
						<svg className="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
						</svg>
						Get Hint
					</Button>
					<Button variant="destructive" className="w-36 transition-all duration-200">
						<svg className="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
